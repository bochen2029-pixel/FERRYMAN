"""Translation stage (Head D · cross-lingual dub) — runs INSIDE a venv with `transformers`
(venv-oracle: transformers 4.51 + torch 2.4.1). Loads NLLB-200 once, translates every item.
